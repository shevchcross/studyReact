...
import studyReact.TicketStore;
import studyReact.config.TestApplication;
import studyReact.converter.HeaderSettingsRequestCallback;
import studyReact.converter.ResponseResults;
...
@ContextConfiguration(loader = SpringBootContextLoader.class, classes = {TicketStore.class, TestApplication.class})
@ComponentScan(basePackages = "studyReact")
@ActiveProfiles("TEST")
@Slf4j
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)public class CommonStep {
